...
class BlogpostForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'blog_title': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Enter the title of the blog post...'}),
            ...
            'excerpt': forms.Textarea(attrs={'class': 'form-control', 'rows': 2, 'placeholder': 'Write a short excerpt...(max length 100 characters)', 'maxlength': '100'}),
