...
class TestViews(TestCase):
    ...
    def setUp(self):
        ...
        # Login with owner user for tests that require authentication
    ...
    def test_BlogpostCreateView_GET(self):
        """
        Test BlogpostCreateView for successful GET by authenticated user.
        """
        self.client.login(username='owneruser', password='123password')
    ...
    def test_create_blogpost(self):
        ...
        self.assertRedirects(response,
                             reverse('blogpost_detail', args=[new_post.slug]))

    def test_BlogpostUpdateView_GET(self):
        """
        Test BlogpostUpdateView to load correctly for post's owner.
        """
        self.client.login(username='owneruser', password='123password')
    ...
    def test_update_blogpost(self):
        ...
        self.assertRedirects(
            response, reverse(
                'blogpost_detail', args=[self.owner_blogpost.slug]
            )
        )
    ...
    def test_BlogpostDeleteView_GET(self):
        """
        Test BlogpostDeleteView to load correctly for post's owner.
        """
        self.client.login(username='owneruser', password='123password')
        response = self.client.get(
